...
// кроме ровно 4 или ровно 6 цифр. Необходимо написать регулярное выражение для данной строки. 
// Если же строка подходит под регулярное выражение, то вывести булевое true, 
// в противном случае бросить исключение и обработать "1234“ -> true "12345“ -> false "a234“ -> false

const str = '1234';

function isValid(str) {
    try {
        if ((!/^[0-9]{4}$/g.test(str)) && (!/^[0-9]{6}$/g.test(str))) {
